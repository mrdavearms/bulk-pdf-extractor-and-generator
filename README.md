...
| macOS | `Bulk.PDF.Generator.macOS.dmg` | macOS 12 Monterey or later |
...
**Mac:** Open **`Bulk.PDF.Generator.macOS.dmg`**, then drag **Bulk PDF Generator** into your Applications folder. Double-click to open from there.
